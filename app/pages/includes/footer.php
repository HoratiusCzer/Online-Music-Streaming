<footer>
        	...
        	<div class="footer-div">
        		Follow us:
        	<br><br>
        	<svg width="16" height="16" fill="white" class="bi bi-facebook" viewBox="0 0 16 16">
            ...
            <svg width="16" height="16" fill="white" class="bi bi-instagram" viewBox="0 0 16 16">
	        ...
	        <svg width="16" height="16" fill="white" class="bi bi-twitter-x" viewBox="0 0 16 16">
